...
import { I_Product_Data, F_Update_Product_Status, F_Delete_Product_By_Id } from '@/shared/utils/storage_utils';
import { useJobManager } from '@/shared/context/JobContext';
        ...
        <>
            ...
            >
                ...
                <div className={`aspect-[3/4] bg-secondary/10 relative overflow-hidden`}>
                    ...
                    {p_product.model_video && !is_video_updating && (
                        <video
